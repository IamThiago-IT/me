...
`,
	...
	contact: {
		...
		proposalCta: {
			...
			description:
				"Have a project in mind? Send me the details and I'll get back to you soon.",
			back: "Back to Contact",
		},
		form: {
			title: "Send a Proposal",
			subtitle:
				"Fill out the form below to send me a project proposal or direct contact.",
			name: "Name",
			namePlaceholder: "Your full name",
			email: "Email",
			emailPlaceholder: "your@email.com",
			subject: "Subject",
			subjectPlaceholder: "E.g.: Web project proposal",
			...
			message: "Message",
			messagePlaceholder: "Describe your project, needs, and expectations...",
			send: "Send Proposal",
			sending: "Sending...",
			successMessage: "Proposal sent successfully! I'll get back to you soon.",
			errorMessage: "Error sending the proposal. Please try again later.",
		},
	},
	...
	feedbacks: {
		...
		description:
			"Learn about the experiences of clients I've worked with. Their feedback helps me improve continuously.",
		project: "Project",
		...
		feedbackCTA:
			"Worked with me? Leave your feedback and help others discover my work!",
	...
	newsletter: {
		...
		description:
			"Get the best news and updates delivered directly to your email.",
	...
	blog: {
		title: "Blog",
		description:
			"Articles from my TabNews - sharing knowledge about web development and technology.",
		...
		error: "Error loading TabNews articles",
		tryAgain: "Try again",
	...
	schedule: {
		...
		selectDescription: "Choose the best time for our meeting through Cal.com",
	},
	...
	contracts: {
		...
		contractInfoDescription: "Fill in the details to generate the contract",
		projectName: "Project Name",
		projectValue: "Project Value",
		projectDescription: "Project Description",
		previewAndSign: "Preview & Sign",
		previewDescription: "Review and sign the contract",
		serviceContract: "Service Agreement",
		project: "Project",
		value: "Value",
		description: "Description",
		signAndFinish: "Sign & Complete",
		contractTemplates: "Contract Templates",
		selectTemplate: "Select a template to get started",
		useTemplate: "Use Template",
		signedContracts: "Signed Contracts",
		signedDescription: "History of completed and in-progress contracts",
		completed: "Completed",
		...
		mobileNotice:
			"We're working to adapt this page for mobile devices. For now, please access it from your computer for the best experience.",
		templateNames: [
			"Web Development",
			"Consulting",
			"Maintenance",
	...
	cv: {
		...
		chooseLanguage: "Choose the language • Escolha o idioma",
		note: "Place PDF files in /public as",
	},
	...
	notFound: {
		...
		question: "Are you a little lost?",
		devMessage:
			"If you're a developer or worker: moments of uncertainty happen. Recalibrate, learn something new today, and keep building.",
		jobMessage:
			'For those seeking work and only getting "no": I understand. It has been',
		attempts: 'application attempts and many "nos" — and yet I never gave up.',
		encouragement:
			'Persistence, small learnings, and taking care of your mental health make all the difference. A "no" today might be the step towards a bigger "yes" tomorrow.',
	...
	events: {
		...
		inviteMe: "Invite Me to an Event",
		inviteDescription:
			"Fill in your event details and invite me to participate. I do talks, workshops and other engagement activities.",
		inviteSent: "Invitation sent successfully!",
		inviteError: "Error sending invitation. Please try again.",
		pleaseSelectDate: "Please select a date for the event",
		eventDetails: "Event Details",
		fillEventInfo: "Fill in your event information",
		...
		descriptionForm: "Description and Details",
		sending: "Sending...",
