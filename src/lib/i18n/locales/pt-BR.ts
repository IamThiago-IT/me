const ptBR = {
  ...
  about: {
    ...
    journeyDescription: "Conheça mais sobre minha jornada profissional e acadêmica em detalhes.",
...
`,
  ...
  contact: {
    ...
    form: {
      ...
      message: "Mensagem",
      messagePlaceholder: "Descreva seu projeto, necessidades e expectativas...",
  ...
  projects: {
    ...
    loadError: "Não foi possível carregar os projetos. Por favor, tente novamente mais tarde.",
  },
  ...
  newsletter: {
    ...
    description: "Receba as melhores novidades e atualizações diretamente no seu e-mail.",
  ...
  blog: {
    title: "Blog",
    description: "Artigos do meu TabNews - compartilhando conhecimento sobre desenvolvimento web e tecnologia.",
  ...
  schedule: {
    ...
    selectDescription: "Escolha o melhor momento para nossa reunião através do Cal.com",
  },
  ...
  notFound: {
    ...
    attempts: "tentativas de candidatura e muitos \"nãos\" — e ainda assim nunca desisti.",
    encouragement:
  ...
  events: {
    ...
    inviteDescription: "Preencha os detalhes do seu evento e me convide para participar. Faço palestras, workshops e outras ações de engajamento.",
